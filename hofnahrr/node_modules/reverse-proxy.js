 ...
 * @description Creates a new deployd resource, that acts as reverse proxy.
 * This is needed for example for accessing Wikipedia. It just hands through
 * requests to this ressource to the desired one and passes back the response.
 */
